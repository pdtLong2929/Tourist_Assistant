...
from app.services.efm_logic import calculate_cold_start_score, get_user_context, state, generate_ai_explanation, get_user_interests, get_destination_features, validate_location_in_city
router = APIRouter()
